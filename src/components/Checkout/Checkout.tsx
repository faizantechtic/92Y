                                ...
                                cardLoad ? (
                                    ...
                                    <>
                                        ...
                                        {cardDetails.card ? (
                                            ...
                                            <RadioField
                                                className={isMac ? 'mac-radio-btn card-radio-btn' : 'card-radio-btn'}
                                                onClick={() => {
                                                    setFormValue('othercard');
                                                    setCheckoutScreen(CheckoutScreens.CARD_INFO);
                                                    setPaymentType('othercard');
                                            ...
                                            >
                                                <RadioFieldInput
                                                    className={
                                                        isMac ? 'mac-radio-btn card-radio-btn' : 'card-radio-btn'
                                                    }
                                                >
                                                    <input
                ...
                <CheckoutFooterPrice>
                    ...
                    {loading ? (
                        ...
                        <Button
                            ...
                            className={shouldBeFree ? 'subscribed-enroll-btn' : 'submit-payment-btn'}
                        >
