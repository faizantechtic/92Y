...
const EnrolledModal: FC<EnrolledModalProps> = ({ setIsEnrollModalVisible, isEnrollModalVisible, price }) => {
    ...
    return (
        <OnBoardingModal
            ...
            closeBtn={true}
            closeIcon={<PopupCloseBtn className="confirm-enrollment" />}
            maskClosable={false}
        >
                        ...
                        <OnBoardingHeaderCol md={6}>
                            <div className="onboarding-header-text onboarding-1">
                                ...
                                <EnrolledFooter>
                                        ...
                                        <Link href="/my-courses">
                                            <a>
                                                <Button
                                                    ...
                                                    bgcolor="#F9D8C5"
                                                    color="#000000"
                                                    className="align-self-end confirm-enrollment"
                                                    lg
                                                >
                                                    View My Courses
                                                </Button>
                                    ...
                                    <Text className="text-decoration-underline confirm-enrollment">
                                        <a
                                            onClick={() => {
                                                setIsEnrollModalVisible(false);
                                            }}
