...
const LayoutWrapper: FC<WrapperType> = ({ children, navbarColor, button, learner, className }) => {
    const siteName = `Roundtable Founded by 92nd Street Y`;
    const title = 'Roundtable by The 92nd Street Y, New York — Live, Online Courses';
    const description =
